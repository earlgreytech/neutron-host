...
const MAX_STACK_ITEM_SIZE: &'static usize = &100;
...
pub unsafe extern "C" fn main() -> ! {
    ...
    __system_call(0x8000_0001, 10); // DebugDataFunctions::GetInputStackLen
    ...
    // Reverse order of provided input stack to counter the order flipping used by the next code section
     __system_call(0x8000_0001, 11); // DebugDataFunctions::ReverseInputStack
