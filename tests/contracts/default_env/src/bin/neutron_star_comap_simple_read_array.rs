...
const ERR_STR_STACKITEMTOOLARGE: &str = "StackItemTooLarge (The comap item was larger than this function's data type or expected array length)";
const ERR_STR_STACKITEMTOOSMALL: &str = "StackItemTooSmall (The comap item was smaller than this function's data type or expected array length)";
...
pub unsafe extern "C" fn main() -> ! {
    ...
    if abi_data == ABI_VALUE_U8 + ABI_ARRAY_BIT {
        ...
        match read_result_comap_fixed_array_u8(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_u8(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_u8(): {}", ERR_STR_STACKITEMTOOSMALL),
        ...
        match read_result_comap_fixed_array_u16(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_u16(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_u16(): {}", ERR_STR_STACKITEMTOOSMALL),
        ...
        match read_result_comap_fixed_array_u32(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_u32(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_u32(): {}", ERR_STR_STACKITEMTOOSMALL),
        ...
        match read_result_comap_fixed_array_i16(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_i16(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_i16(): {}", ERR_STR_STACKITEMTOOSMALL),
        ...
        match read_result_comap_fixed_array_i32(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_i32(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_i32(): {}", ERR_STR_STACKITEMTOOSMALL),
        ...
        match read_result_comap_fixed_array_i64(".namespace.keyname", &mut value) {
            Ok(()) => push_costack_array_i64(&value),
            ...
            Err(RecoverableError::StackItemTooSmall) => println!("Error in read_result_comap_fixed_array_i64(): {}", ERR_STR_STACKITEMTOOSMALL),
