...
const ERR_STR_STACKITEMTOOLARGE: &str = "StackItemTooLarge (The costack input was larger than this function's data type)";
const ERR_STR_STACKITEMTOOSMALL: &str = "StackItemTooSmall (The costack input was smaller than this function's data type)";
...
pub unsafe extern "C" fn main() -> ! {
    ...
    if abi_data == ABI_VALUE_U8 {
        match pop_costack_u8() {
            Ok(v) => write_comap_u8(".namespace.keyname", v),
        ...
        match pop_costack_u16() {
            Ok(v) => write_comap_u16(".namespace.keyname", v),
        ...
        match pop_costack_u32() {
            Ok(v) => write_comap_u32(".namespace.keyname", v),
        ...
        match pop_costack_u64() {
            Ok(v) => write_comap_u64(".namespace.keyname", v),
        ...
        match pop_costack_i8() {
            Ok(v) => write_comap_i8(".namespace.keyname", v),
        ...
        match pop_costack_i16() {
            Ok(v) => write_comap_i16(".namespace.keyname", v),
        ...
        match pop_costack_i32() {
            Ok(v) => write_comap_i32(".namespace.keyname", v),
        ...
        match pop_costack_i64() {
            Ok(v) => write_comap_i64(".namespace.keyname", v),
