...
pub unsafe extern "C" fn main() -> ! {
    ...
    __move_input_to_output_costack(); // Injected input stack -> input for peek_result_comap in loop
    ...
    __move_input_to_output_costack(); // Result input from peek_result_comap in loop -> Output stack for assertion
