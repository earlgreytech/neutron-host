...
fn test_comap_push_header_size_1() {
    ...
    debugdata.injected_input_stack.push_str(raw_value);
    debugdata.injected_input_stack.push_u32(abi_data);
...
fn negtest_comap_push_header_wrong_key() {
    ...
    debugdata.injected_input_stack.push_str(wrong_key);
    debugdata.injected_input_stack.push_str(raw_value);
    debugdata.injected_input_stack.push_u32(abi_data);
...
fn negtest_comap_push_header_wrong_value() {
    ...
    debugdata.injected_input_stack.push_str(key);
    debugdata.injected_input_stack.push_str(wrong_raw_value);
    debugdata.injected_input_stack.push_u32(abi_data);
...
fn negtest_comap_push_header_wrong_size() {
    ...
    debugdata.injected_input_stack.push_str(key);
    debugdata.injected_input_stack.push_str(raw_value);
    debugdata.injected_input_stack.push_u32(wrong_abi_data);
